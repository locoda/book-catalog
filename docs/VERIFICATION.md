...
## 1. 联网核实（针对第 0 步筛出的可疑条目 + QUESTIONS.md 里已标"推断"的条目 + CATALOGING §9 编目查证）
...
初版年判定要点：出版社页/书目页标注的是**该版本**年份，需区分「初版 première édition / 単行本初版 / first edition」与文库本、新装版、译本。Wikipedia 作品条目通常直接给初版年，可用但需与书目来源互证；来源互相矛盾时取书目级来源，并在报告里注明矛盾。
